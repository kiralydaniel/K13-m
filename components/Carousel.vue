      ...
      <div class="relative">
        ...
        <div class="relative h-[336px] overflow-hidden rounded-lg sm:h-[384px] xl:h-[480px] 2xl:h-[576px]">
          ...
          <div id="carousel-item-2" class="hidden duration-1000 ease-in-out">
            <img src="/carousel02.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>

          <div id="carousel-item-3" class="hidden duration-1000 ease-in-out">
            <img src="/carousel03.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>

          <div id="carousel-item-4" class="hidden duration-1000 ease-in-out">
            <img src="/carousel04.jpg" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
          </div>
        </div>
